...
switch isothermModel
    ...
    case 'STATZGATE'
        ...
        %         logMLE = @(par) -generateMLEfun(x, y, z, 1, 'STATZGATE', isoRef, par(1), par(2), par(3), par(4), par(5), par(6), par(7), vc1, vc2);
        %         for jj = 1:Np
        %             for kk = 1:Np
        %                 partempnumj = partemp.*(1+deltaplus1mat(jj,:));
        %                 partempdenj = partemp.*deltamat(jj,:);
        ...
        for jj = 1:7
            for kk = 1:length(x)
                ...
                elseif jj == 5
                    sensitivityMatrix(kk,jj) = (computeStatZGATELoading(x(kk),y(kk),b01,delU1,beta,omega,(1+del)*kgate,cgate,gamma,vc1,vc2) - fitVals(kk))/(del*kgate);
                elseif jj == 6
        ...
        switch fittingMethod
            case 'MLE'
                ...
                for jj = 1:8
                    for kk = 1:length(x)
                        if jj == 1
                            sensitivityMatrix(kk,jj) = abs(((((1+del)*qs1)*b01*x(kk)*exp(delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^(toth0 + totha.*(1-298/y(kk)))).^(1./(toth0 + totha.*(1-298/y(kk)))) ...
                                - fitVals(kk))/(del*qs1));
                        elseif jj == 2
                            sensitivityMatrix(kk,jj) = abs((((1+del)*qs1*b01*x(kk)*exp(delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^(toth0 + totha.*(1-298/y(kk)))).^(1./(toth0 + totha.*(1-298/y(kk)))) ...
                                - fitVals(kk))/(del*qs1));
                        elseif jj == 3
                            sensitivityMatrix(kk,jj) = abs(((qs1*(1+del)*b01*x(kk)*exp(delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^(toth0 + totha.*(1-298/y(kk)))).^(1./(toth0 + totha.*(1-298/y(kk)))) ...
                                - fitVals(kk))/(del*b01));
                        elseif jj == 4
                            sensitivityMatrix(kk,jj) = abs(((qs1*(1+del)*b01*x(kk)*exp(delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^(toth0 + totha.*(1-298/y(kk)))).^(1./(toth0 + totha.*(1-298/y(kk)))) ...
                                - fitVals(kk))/(del*b01));
                        elseif jj == 5
                            sensitivityMatrix(kk,jj) = abs(((qs1*b01*x(kk)*exp((1+del)*delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^(toth0 + totha.*(1-298/y(kk)))).^(1./(toth0 + totha.*(1-298/y(kk)))) ...
                                - fitVals(kk))/(del*delU1));
                        elseif jj == 6
                            sensitivityMatrix(kk,jj) = abs(((qs1*b01*x(kk)*exp((1+del)*delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^(toth0 + totha.*(1-298/y(kk)))).^(1./(toth0 + totha.*(1-298/y(kk)))) ...
                                - fitVals(kk))/(del*delU1));
                        elseif jj == 7
                            sensitivityMatrix(kk,jj) = abs(((qs1*b01*x(kk)*exp(delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^((1+del)*toth0 + totha.*(1-298/y(kk)))).^(1./((1+del)*toth0 + totha.*(1-298/y(kk)))) ...
                                - fitVals(kk))/(del*toth0));
                        else
                            sensitivityMatrix(kk,jj) = abs(((qs1*b01*x(kk)*exp(delU1/(8.314*y(kk))))/(1+(b01*x(kk)*exp(delU1/(8.314*y(kk))))^(toth0 + (1+del)*totha.*(1-298/y(kk)))).^(1./(toth0 + (1+del)*totha.*(1-298/y(kk)))) ...
